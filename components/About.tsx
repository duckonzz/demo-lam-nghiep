...
const About: React.FC = () => {
  ...
  return (
    <section
      id="gioi-thieu"
      className="py-20 lg:py-28 bg-background-light overflow-hidden"
    >
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 relative group">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-[4/3]">
              <img
                src="https://i.pinimg.com/736x/d5/ec/80/d5ec80a79458eba43586f13a789caede.jpg"
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-6">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Chúng tôi tự hào là đơn vị hàng đầu trong lĩnh vực nghiên cứu và
              phát triển giống cây lâm nghiệp bằng công nghệ nuôi cấy mô hiện
              đại. Với đội ngũ kỹ sư giàu kinh nghiệm, chúng tôi cam kết mang
              đến những giống cây khỏe mạnh, sạch bệnh và năng suất cao nhất.
            </p>
            ...
            <div className="pt-4">
              <Link
                to="/gioi-thieu"
                className="flex items-center gap-2 text-primary-foreground font-bold hover:gap-4 transition-all group"
              >
